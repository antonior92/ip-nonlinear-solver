...
IMPORTANT: These algorithms have been integrated SciPy library (release 1.1 or above) under the name of ``trust-constr``. The version available there is more complete and better mantained.
